...
# ---------------- CONFIG ----------------
TRAIN_PATH = "ensemble_ml/data/splits/train.csv"
VAL_PATH = "ensemble_ml/data/splits/val.csv"
TEST_PATH = "ensemble_ml/data/splits/test.csv"
MODEL_DIR = "ensemble_ml/models"
MODEL_PATH = "ensemble_ml/models/ensemble_tfidf.joblib"
RANDOM_STATE = 42
# ---------------------------------------
